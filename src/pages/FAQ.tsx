...
const faqs = [
  {
    ...
    questions: [
      ...
      { q: "Is UpSkillers free to use?", a: "Yes! UpSkillers is completely free for students. You can browse internships, apply, and use all features at no cost." },
      { q: "What makes UpSkillers different?", a: "UpSkillers uses advanced AI algorithms to match you with internships based on your skills, preferences, and career goals. We provide personalized recommendations, skill gap analysis, and career guidance." }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      { q: "Who is behind UpSkillers?", a: "UpSkillers is developed by Team HexaForces, a group of passionate developers and educators committed to empowering students in India with AI-driven career guidance and internship opportunities." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "What are the theme options?", a: "UpSkillers supports both light and dark modes. Your theme preference is saved automatically and syncs across all your devices." },
      { q: "Is there a mobile app?", a: "UpSkillers is a Progressive Web App (PWA). You can install it on your mobile device for an app-like experience with offline capabilities and push notifications." },
  ...
  },
  {
    ...
    questions: [
      { q: "What is your refund policy?", a: "UpSkillers is completely free for students, so there are no refunds applicable. All features and services are provided at no cost." },
      { q: "What are the terms of service?", a: "By using UpSkillers, you agree to use the platform responsibly, provide accurate information, and not engage in fraudulent activities. Full terms are available in our Terms of Service page." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Can I use UpSkillers on my phone?", a: "Yes! UpSkillers is fully responsive and works on all devices. For the best mobile experience, install it as a PWA by clicking 'Add to Home Screen' in your browser menu." },
  ...
  return (
    <div className="container max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">Find answers to common questions about UpSkillers - Platform, Privacy, Policies & More</p>
      </div>
