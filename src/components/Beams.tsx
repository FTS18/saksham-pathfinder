...
const CanvasWrapper = ({ children, isDark }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="absolute inset-0 w-full h-full">
    {children}
...
const Beams = ({
  ...
  const lightColor = themeColors[colorTheme] || themeColors.blue;
