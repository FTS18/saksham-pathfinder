...
const colorThemes = [
  { id: 'green' as const, name: 'Green', color: 'bg-green-500' },
  { id: 'blue' as const, name: 'Blue', color: 'bg-blue-500' },
  { id: 'red' as const, name: 'Red', color: 'bg-red-500' },
  { id: 'yellow' as const, name: 'Yellow', color: 'bg-yellow-500' },
  { id: 'grey' as const, name: 'Grey', color: 'bg-gray-900' }
];
...
export const Settings = ({ dashboardProfile, onProfileUpdate }: SettingsProps) => {
  ...
  return (
    <div className="space-y-6 relative z-10 max-h-[calc(100vh-8rem)] overflow-y-auto pb-20 md:pb-6 px-2 md:px-0">
