 ...
 */
export const isEnterKey = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "Enter";
export const isSpaceKey = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === " ";
export const isEscapeKey = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "Escape";
export const isArrowLeft = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "ArrowLeft";
export const isArrowRight = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "ArrowRight";
export const isArrowUp = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "ArrowUp";
export const isArrowDown = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "ArrowDown";
export const isTabKey = (e: KeyboardEvent | React.KeyboardEvent) =>
  e.key === "Tab";
